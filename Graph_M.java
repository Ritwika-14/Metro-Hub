...
public class Graph_M {
	...
	public static void Create_Metro_Map(Graph_M g) {
		g.addVertex("Noapara~NP");
		g.addVertex("Dum Dum~DD");
		g.addVertex("Belgachia~BA");
		g.addVertex("Shyambazar~SB");
		g.addVertex("Bidhan Nagar~BN");
		g.addVertex("Central~CA");
		g.addVertex("Chandni Chowk~CC");
		g.addVertex("Esplanade~ES");
		g.addVertex("Park Street~PS");
		g.addVertex("Maidan~MA");
		g.addVertex("Rabindra Sadan~RS");
		g.addVertex("Netaji Bhavan~NB");
		g.addVertex("Mahanayak Uttam Kumar~MK");
		g.addVertex("New Garia~NG");
		g.addVertex("Kavi Subhash~KS");
		g.addVertex("Salt Lake Sector V~SV");
		g.addVertex("Karunamoyee~KM");
		g.addVertex("Central Park~CP");
		g.addVertex("City Centre~CC");
		g.addVertex("Salt Lake Stadium~SS");

		g.addEdge("Noapara~NP", "Dum Dum~DD", 8);
		g.addEdge("Dum Dum~DD", "Belgachia~BA", 10);
		g.addEdge("Belgachia~BA", "Bidhan Nagar~BN", 8);
		g.addEdge("Belgachia~BA", "Shyambazar~SB", 6);
		g.addEdge("Shyambazar~SB", "Central~CA", 9);
		g.addEdge("Central~CA", "Chandni Chowk~CC", 7);
		g.addEdge("Chandni Chowk~CC", "Esplanade~ES", 6);
		g.addEdge("Huda City Center~Y", "Maidan~MA", 15);
		g.addEdge("Maidan~MA", "New Garia~NG", 6);
		g.addEdge("New Garia~NG", "Shyambazar~SB", 7);
		g.addEdge("Shyambazar~SB", "Mahanayak Uttam Kumar~MK", 1);
		g.addEdge("Mahanayak Uttam Kumar~MK", "Netaji Bhavan~NB", 2);
		g.addEdge("Netaji Bhavan~NB", "Rabindra Sadan~RS", 5);
		g.addEdge("Mahanayak Uttam Kumar~MK", "Kavi Subhash~KS", 2);
		g.addEdge("Kavi Subhash~KS", "Salt Lake Sector V~SV", 7);
		g.addEdge("Salt Lake Sector V~SV", "Karunamoyee~KM", 8);
		g.addEdge("Central~CA", "Central Park~CP", 2);
		g.addEdge("Salt Lake Stadium~SS", "Central Park~CP", 2);
		g.addEdge("Salt Lake Stadium~SS", "City Centre~CC", 3);
	}
